  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id="help"><a class="top"><?php echo $text_help; ?></a>
        <ul>
          <li><a href="http://opencart-russia.ru" target="_blank"><?php echo $text_opencart; ?></a></li>
          <li><a href="http://forum.opencart-russia.ru" target="_blank"><?php echo $text_support; ?></a></li>
		  <li><a href="http://shop.opencart-russia.ru" target="_blank"><?php echo $text_documentation; ?></a></li>
        </ul>
      </li>
    </ul>
